...
print(f"Slope: {round(reg.coef_[0], 4)}")
print(f"Intercept: {round(reg.intercept_, 4)}")
print("\n########## Stats on Training Dataset ##########")
print(f"R-Squared Score: {round(reg.score(feature_train, target_train), 4)}")
print("\n########## Stats on Test Dataset ##########")
print(f"R-Squared Score: {round(reg.score(feature_test, target_test), 4)}")
